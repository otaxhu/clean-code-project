...
func (_m *Repository) GetUserRoles(ctx context.Context, userId string) ([]entity.UserRole, error) {
	ret := _m.Called(ctx, userId)
...
func (_m *Repository) SaveUserRole(ctx context.Context, userId string, roleId int) error {
	ret := _m.Called(ctx, userId, roleId)
